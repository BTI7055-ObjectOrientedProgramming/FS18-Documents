...
public final class Person implements Serializable{
	...
	/**
	 * Creates a Person object. The fields are initialized by parsing a line string. The line string must have
	 * the form <code>[firstname] [name], [birthdate], [marital status]</code>. Such strings are produced by
	 * <code>toString()</code>.
	 * @param line The String to be parsed for field initialization.
	 * @throws IllegalArgumentException if line does not contain 4 tokens separated by comma and/or whitespace or
	 *         if fourth token is not a valid marital status name
	...
	public Person(String line) {
		...
		if (values.length != 4) throw new IllegalArgumentException("Illegal number of tokens in line. Expected: 4: Actual: " + values.length);
		firstname = values[0];
		lastname = values[1];
